...
sqlSave(channel = channelOracle, dat = df_data, tablename = "GA.GADC0_98AEV_V01", append = TRUE, rownames = FALSE, colnames = FALSE, fast = FALSE)
close(firstData)
...
sqlSave(channel = channelOracle, dat = df_data, tablename = "GA.GADD0_98AEV_V01", append = TRUE, rownames = FALSE, colnames = FALSE, fast = FALSE)
close(secondData)
...
sqlSave(channel = channelOracle, dat = df_data, tablename = "GA.GADF2_04AEV_V01", append = TRUE, rownames = FALSE, colnames = FALSE, fast = FALSE)
close(thirdData)
...
sqlSave(channel = channelOracle, dat = df_data, tablename = "GA.GADF3_04AEV_V01", append = TRUE, rownames = FALSE, colnames = FALSE, fast = FALSE)
close(fourthData)
